...
vehNATOLightArmed = ["rhsusf_m1025_w_s_m2","rhsusf_rg33_m2_usmc_wd","rhsgref_cdf_b_reg_uaz_dshkm"];
vehNATOLightUnarmed = ["rhsusf_m1025_w_s","rhsusf_m998_w_s_2dr","rhsusf_m998_w_s_2dr_fulltop","rhsusf_m998_w_s_4dr","rhsgref_cdf_b_reg_uaz","rhsgref_cdf_b_reg_uaz_open"];
vehNATOTrucks = ["rhsusf_M1078A1P2_wd_open_fmtv_usarmy","rhsusf_M1078A1P2_B_wd_fmtv_usarmy","rhsusf_M1078A1P2_B_wd_open_fmtv_usarmy","rhsusf_M1083A1P2_wd_fmtv_usarmy","rhsgref_cdf_b_ural","rhsgref_cdf_b_gaz66o"];
vehNATOAmmoTruck = "rhsgref_cdf_b_gaz66_ammo";
vehNATORepairTruck = "rhsgref_cdf_b_ural_repair";
vehNATOLight = vehNATOLightArmed + vehNATOLightUnarmed;
vehNATOAPC = ["rhsgref_BRDM2_HQ_b","rhsgref_BRDM2UM_b","rhsgref_BRDM2_b","rhsgref_BRDM2_ATGM_b","RHS_M2A3_BUSKIII_wd","RHS_M2A3_BUSKI_wd","RHS_M2A3_wd","RHS_M2A3_wd","RHS_M2A2_BUSKI_WD","RHS_M2A2_wd","rhsusf_m113_usarmy_M240","rhsusf_m113_usarmy_MK19","rhsgref_cdf_b_btr60","rhsgref_cdf_b_btr70","rhsgref_cdf_b_bmp2d","rhsgref_cdf_b_bmp2e","rhsgref_cdf_b_bmd2k","rhsgref_cdf_b_bmd1pk"];//"B_T_APC_Tracked_01_CRV_F" has no cargo seats
vehNATOTank = ["rhsusf_m1a1fep_wd","rhsgref_cdf_b_t80b_tv","rhsgref_cdf_b_t72bb_tv"];
vehNATOAA = ["RHS_M6","rhsgref_cdf_b_zsu234","rhsgref_cdf_b_ural_Zu23"];
...
vehNATOPlane = ["RHS_A10_AT","rhsgref_cdf_b_su25"];
vehNATOPlaneAA = ["rhsusf_f22","rhsgref_cdf_b_mig29s"];
vehNATOPatrolHeli = "RHS_MELB_MH6M";
vehNATOTransportHelis = ["RHS_UH60M_d","RHS_CH_47F",vehNATOPatrolHeli,"RHS_C130J","RHS_AN2_B","rhsgref_cdf_b_reg_Mi8amt","rhsgref_cdf_b_reg_Mi17Sh"];
vehNATOAttackHelis = ["RHS_MELB_AH6M_L","RHS_AH64D_wd","RHS_UH1Y","rhsgref_cdf_b_reg_Mi17Sh","rhsgref_b_mi24g_CAS","rhsgref_cdf_b_Mi24D"];
...
gruposNATOSentry = ["rhsusf_usmc_marpat_wd_grenadier","rhsgref_cdf_b_reg_rifleman","rhsgref_cdf_b_reg_rifleman"];//"B_T_InfSentry";//
gruposNATOSniper = ["rhsusf_socom_marsoc_sniper","rhsusf_socom_marsoc_spotter","rhsgref_cdf_b_reg_marksman","rhsgref_cdf_b_reg_marksman"];
gruposNATOsmall = [gruposNATOSentry,gruposNATOSniper]; //[gruposNATOSentry,"B_T_SniperTeam","B_T_ReconSentry"];///
gruposNATOAA = [["rhsusf_usmc_marpat_wd_teamleader","rhsusf_usmc_marpat_wd_autorifleman","rhsusf_usmc_marpat_wd_rifleman_m4","rhsusf_usmc_marpat_wd_stinger"],["rhsgref_cdf_b_reg_squadleader","rhsgref_cdf_b_reg_machinegunner","rhsgref_cdf_b_reg_rifleman","rhsgref_cdf_b_reg_specialist_aa"]];
gruposNATOAT = [["rhsusf_usmc_marpat_wd_teamleader","rhsusf_usmc_marpat_wd_autorifleman","rhsusf_usmc_marpat_wd_rifleman_m4","rhsusf_usmc_marpat_wd_javelin"],["rhsgref_cdf_b_reg_squadleader","rhsgref_cdf_b_reg_machinegunner","rhsgref_cdf_b_reg_rifleman","rhsgref_cdf_b_reg_grenadier_rpg"]];
...
NATOSquad = ["rhsgref_cdf_b_para_squadleader","rhsgref_cdf_b_para_grenadier_rpg","rhsgref_cdf_b_para_grenadier_rpg","rhsgref_cdf_b_para_machinegunner","rhsgref_cdf_b_para_machinegunner","rhsgref_cdf_b_para_medic","rhsgref_cdf_b_para_rifleman","rhsgref_cdf_b_para_rifleman"];//"B_T_InfSquad";//
