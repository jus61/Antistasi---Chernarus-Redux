...
vehCSATLightArmed = ["rhsgref_BRDM2_vdv","rhsgref_BRDM2_HQ_vdv","rhsgref_BRDM2_ATGM_vdv","rhs_tigr_sts_vdv","rhsgref_BRDM2_ATGM_ins","rhsgref_BRDM2_HQ_ins"];
vehCSATLightUnarmed = ["rhs_tigr_vdv","rhs_uaz_vdv","rhsgref_BRDM2UM_ins"];
vehCSATTrucks = ["rhs_kamaz5350_vdv","rhs_kamaz5350_open_vdv","RHS_Ural_Open_VDV_01","rhs_gaz66_vdv","rhsgref_ins_ural","rhsgref_ins_gaz66"];
vehCSATAmmoTruck = ["rhs_gaz66_ammo_vmf","rhsgref_ins_gaz66_ammo"];
vehCSATLight = vehCSATLightArmed + vehCSATLightUnarmed;
vehCSATAPC = ["rhs_btr80a_vdv","rhs_bmp2d_vdv","rhs_bmp1p_vdv","rhsgref_ins_btr60","rhsgref_ins_bmd1p"];
vehCSATTank = ["rhs_sprut_vdv","rhsgref_ins_t72bb","rhs_t80bk","rhs_t90a_tv"];
vehCSATAA = ["rhs_zsu234_aa","rhsgref_ins_gaz66_zu23"];
...
vehCSATPlaneAA = ["RHS_T50_vvs_051","rhs_mig29s_vvsc"];
vehCSATPatrolHeli = "rhs_ka60_c";
vehCSATTransportHelis = ["RHS_Mi8mt_vdv","RHS_Mi8mt_vv","RHS_Mi8mt_Cargo_vv",vehCSATPatrolHeli];
vehCSATAttackHelis = ["RHS_Mi24V_vdv","RHS_Mi8MTV3_FAB_vdv","RHS_Ka52_vvsc","rhs_mi28n_vvsc"];
...
gruposCHDKZSentry = ["rhsgref_ins_rifleman","rhsgref_ins_rifleman_aksu"];
gruposCHDKZSniper = ["rhsgref_ins_sniper","rhsgref_ins_spotter"];
gruposCHDKZAA = ["rhsgref_ins_squadleader","rhsgref_ins_specialist_aa","rhsgref_ins_specialist_aa","rhsgref_ins_specialist_aa"];
gruposCHDKZAT = ["rhsgref_ins_squadleader","rhsgref_ins_grenadier_rpg","rhsgref_ins_grenadier_rpg","rhsgref_ins_grenadier_rpg"];
gruposCHDKZmid = [gruposCHDKZAA,gruposCHDKZAT];
CHDKZsquad = ["rhsgref_ins_squadleader","rhsgref_ins_machinegunner","rhsgref_ins_grenadier","rhsgref_ins_grenadier_rpg","rhsgref_ins_rifleman_RPG26","rhsgref_ins_machinegunner","rhsgref_ins_rifleman","rhsgref_ins_rifleman_aks74"];
gruposCSATSentry = [["rhs_vdv_efreitor","rhs_vdv_rifleman"],gruposCHDKZSentry];///"O_T_InfSentry";///
gruposCSATSniper = [["rhs_vdv_marksman_asval","rhs_vdv_rifleman_asval"],gruposCHDKZSniper];
gruposCSATsmall = [gruposCSATSentry,["rhs_vdv_recon_rifleman_scout_akm","rhs_vdv_recon_rifleman_scout_akm"],gruposCSATSniper,gruposCHDKZSentry,gruposCHDKZSniper];///[gruposCSATSentry,"O_T_reconSentry","O_T_SniperTeam"];///
gruposCSATAA = [["rhs_vdv_flora_junior_sergeant","rhs_vdv_flora_aa","rhs_vdv_flora_aa","rhs_vdv_flora_aa"],gruposCHDKZAA];
gruposCSATAT = [["rhs_vdv_flora_junior_sergeant","rhs_vdv_flora_at","rhs_vdv_flora_strelok_rpg_assist","rhs_vdv_flora_LAT"],gruposCHDKZAT];
gruposCSATmid = [["rhs_vdv_flora_efreitor","rhs_vdv_flora_rifleman","rhs_vdv_flora_rifleman","rhs_vdv_flora_medic"],gruposCSATAA,gruposCSATAT,gruposCHDKZmid];///["O_T_InfTeam","O_T_InfTeam_AA","O_T_InfTeam_AT"];///
CSATSquad = [["rhs_vdv_mflora_sergeant","rhs_vdv_mflora_junior_sergeant","rhs_vdv_mflora_grenadier","rhs_vdv_mflora_machinegunner","rhs_vdv_mflora_at","rhs_vdv_mflora_strelok_rpg_assist","rhs_vdv_mflora_rifleman","rhs_vdv_mflora_medic"],CHDKZsquad];///"O_T_InfSquad";///
