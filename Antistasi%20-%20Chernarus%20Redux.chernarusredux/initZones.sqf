...
if (worldName == "chernarusredux") then
    {
    _mrkCSAT = ["airport_1","puerto_3","puesto","control_30"]
    }
else
    {
    if (worldName == "Altis") then
...
if (worldname == "chernarusredux") then
    {
    _posAntenas = [[6564.3,3404.46,0],[4545.83,3132.89,0],[3028.92,2349.68,0],[13010,5964.95,0],[5263.5,5315.43,0],[3714.3,5985.07,0],[6443.65,6546.57,0],[12936.5,12761.9,0],[4968.36,9965.52,0]];
    _blacklistPos = [8,12];
    _posbancos = [[4566.79,4524.35,0],[6508.27,2530.54,0],[13101.6,7124.47,0]];//same as RT for Bank buildings, select the biggest buildings in your island, and make a DB with their positions.
    antenas = [antena];
...
blackListDest = if (worldname == "chernarusredux") then
                    {
